...
@section('content')
    <div class="max-w-3xl mx-auto py-16 text-center">
        ...
        <p class="text-lg text-gray-600 dark:text-gray-300 mb-8">This feature is coming soon. Here you will be able to view and manage events in a calendar view.</p>
        <div class="mt-8">
