...
@section('content')
    <div class="max-w-3xl mx-auto py-16 text-center">
        ...
        <p class="text-lg text-gray-300 mb-8">This feature is coming soon. Here you will be able to update your account information, change your password, and manage your privacy settings.</p>
        <div class="mt-8">
