        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('timeline.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <select id="event_type" name="event_type" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                ...
                                <option value="birth" {{ old('event_type') == 'birth' ? 'selected' : '' }}>Birth</option>
                                <option value="death" {{ old('event_type') == 'death' ? 'selected' : '' }}>Death</option>
                                <option value="marriage" {{ old('event_type') == 'marriage' ? 'selected' : '' }}>Marriage</option>
                                <option value="divorce" {{ old('event_type') == 'divorce' ? 'selected' : '' }}>Divorce</option>
                                <option value="immigration" {{ old('event_type') == 'immigration' ? 'selected' : '' }}>Immigration</option>
                        ...
                        <div class="flex items-center">
                            <input id="is_public" name="is_public" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" {{ old('is_public') ? 'checked' : '' }}>
